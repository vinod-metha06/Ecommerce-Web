...
class _OrdersDetailsState extends State<OrdersDetails> {
  ...
  updateOrders(context) async {
    var response = await http.post(
      Uri.parse(
        "http://ecom777.000webhostapp.com/Ecommerce/admin/updateorder.php",
      ),
      body: {
  ...
  @override
  void initState() {
    _currentStatus = widget.status.toString();
    ...
    if (status != "Cancel") {
      return Row(
        children: [
          _buildStatusField(),
          FlatButton(
            onPressed: () => updateOrders(context),
            child: Text(
              "update order status",
              style: TextStyle(
                fontSize: 15,
      ...
      return Text('Order Cancelled by User',
          style: TextStyle(
            color: Colors.red,
            fontWeight: FontWeight.bold,
            fontSize: 18,
