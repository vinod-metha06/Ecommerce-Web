...
import 'package:ecom/user/forgotpass.dart';
                                  ...
                                  children: <Widget>[
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        // context,
                                        // PageTransition(
                                        //     type:  PageTransitionType.size,alignment: Alignment.topLeft,
  ...
  login() async {
    if (_formkey.currentState.validate()) {
      ...
      var response = await http.post(
         Uri.parse(
        "http://ecom777.000webhostapp.com/Ecommerce/users/login.php",),
        body: {
